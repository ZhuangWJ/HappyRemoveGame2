...
public class GridReset : MonoBehaviour
{
    ...
    private static void ExchangeGrid(LeaveGridMsg gridA, LeaveGridMsg gridB)
    {
        ...
        //复制互换的对象
        GridBean cloneGridA = GridBean.Clone(mGridBaseListManager[gridA.vertical][gridA.horizontal].gridBean, mGrid);
        GridBean cloneGridB = GridBean.Clone(mGridBaseListManager[gridB.vertical][gridB.horizontal].gridBean, mGrid);
